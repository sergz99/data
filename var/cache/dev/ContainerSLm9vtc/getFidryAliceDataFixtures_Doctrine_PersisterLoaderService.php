...
class getFidryAliceDataFixtures_Doctrine_PersisterLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return new \Fidry\AliceDataFixtures\Loader\PersisterLoader($container->load('getFidryAliceDataFixtures_Loader_SimpleService'), ($container->services['fidry_alice_data_fixtures.persistence.persister.doctrine'] ?? $container->load('getFidryAliceDataFixtures_Persistence_Persister_DoctrineService')), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()), [0 => new \App\DataFixtures\Processor\UserProcessor(($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService')))]);
    }
}
