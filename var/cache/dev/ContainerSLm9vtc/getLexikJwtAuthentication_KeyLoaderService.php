...
class getLexikJwtAuthentication_KeyLoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\RawKeyLoader((\dirname(__DIR__, 4).'/'.$container->getEnv('string:JWT_PRIVATE_KEY_PATH')), (\dirname(__DIR__, 4).'/'.$container->getEnv('string:JWT_PUBLIC_KEY_PATH')), $container->getEnv('JWT_PASSPHRASE'));
    }
}
