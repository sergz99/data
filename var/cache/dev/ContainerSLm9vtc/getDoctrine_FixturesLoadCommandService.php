...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\AppFixtures(($container->services['fidry_alice_data_fixtures.loader.doctrine'] ?? $container->load('getFidryAliceDataFixtures_Loader_DoctrineService'))), 'groups' => []]]);
